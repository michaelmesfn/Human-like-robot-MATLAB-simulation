...
close all
clf
handle_axes= axes('XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
...
h(2)= link_sphere(radius1, trf_viz_link1, [1, 0, 0]); 
...
%% Link-1_2_2
trf_viz_link1p2_2= make_transform([-0.1, 0, 0], 0, 0, 0); % Do not specify parent yet: It will be done in the joint
h(11)= link_box([0.2, 0.02, 0.04], trf_viz_link1p2_2, [0, 0, 0]); 
plot_axes(trf_viz_link1p2_2, ' ', true, axis_length); % V_{1-2}
...
%% Link-1_3_2
trf_viz_link1p3_2= make_transform([-0.2, 0, 0], 0, 0, 0); % Do not specify parent yet: It will be done in the joint
h(12)= link_cylinder(0.035, 0.05, trf_viz_link1p3_2, [0, 0, 1]); 
% plot_axes(trf_viz_link1p3, ' ', true, axis_length); % V_{1-3}

%% Link-2
trf_viz_link2= make_transform([0, 0, 0], 0, 0, 0); % Do not specify parent yet: It will be done in the joint
h(5)= link_sphere(0.03, trf_viz_link2, [1, 0.54902, 0]); 
% V_2 and L_2 are the same.
%% Link-2_2
trf_viz_link2_2= make_transform([0, 0, 0], 0, 0, 0); % Do not specify parent yet: It will be done in the joint
h(13)= link_sphere(0.03, trf_viz_link2_2, [1, 0.54902, 0]); 
% V_2 and L_2 are the same.
%% Link 2-2
...
%% Link 2-2_2
trf_viz_link2p2_2= make_transform([0, 0.05, 0], pi/2, 0, 0); % Do not specify parent yet: It will be done in the joint
h(14)= link_cylinder(0.015, 0.1, trf_viz_link2p2_2, [1, 0.54902, 0]); 
% plot_axes(trf_viz_link2p2, ' ', true, axis_length); % V_{2-2}
...
%% Link-3_2
trf_viz_link3_2= make_transform([0, 0, 0.03], 0, 0, 0); % Do not specify parent yet: It will be done in the joint
h(15)= link_cylinder(0.012, 0.06, trf_viz_link3_2, [0.196078, 0.803922, 0.196078]); 
% plot_axes(trf_viz_link3, ' ', true, axis_length); % V_3

%% Link-3-2
trf_viz_link3p2= make_transform([0, 0, 0.06], pi/2, 0, 0); % Do not specify parent yet: It will be done in the joint
h(8)= link_cylinder(0.062, 0.04, trf_viz_link3p2, [0.196078, 0.803922, 0.196078]); 
% plot_axes(trf_viz_link3p2, ' ', true, axis_length); % V_{3-2}

%% Link-3-2_2
trf_viz_link3p2_2= make_transform([0, 0, -0.06], pi/2, 0, 0); % Do not specify parent yet: It will be done in the joint
h(16)= link_cylinder(0.062, 0.04, trf_viz_link3p2_2, [0.196078, 0.803922, 0.196078]); 
...
%% Joint: Links 1,1_2(2): Fixed
trf_link1p2_link1_2= make_transform([0, 0, 0], 0, 0, 0, trf_link1_joint1); 
make_child(trf_link1p2_link1_2, trf_viz_link1p2_2);
...
%% Joint: Links 1,1_3(2): Fixed
trf_link1p3_link1_2= make_transform([0, 0, 0], 0, 0, 0, trf_link1_joint1); 
make_child(trf_link1p3_link1_2, trf_viz_link1p3_2);
...
%% Joint 2: Links 1,2_2: Revoulute
j2_rot_axis_j2_2= [0,0,1]';
j2_rot_angle_2= 0; % [-pi/2, pi/2]

trf_joint2_link1_2= make_transform([-0.2, 0, 0.045], 0, 0, pi/2, trf_link1_joint1); 
trf_link2_joint2_2= make_transform_revolute(j2_rot_axis_j2_2, j2_rot_angle_2, trf_joint2_link1_2); 
plot_axes(trf_link2_joint2_2, 'L_2(2)', false, axis_length); 
make_child(trf_link2_joint2_2, trf_viz_link2_2);
...
%% Joint: Links 2,2_2_2: Fixed
trf_link2p2_link2_2= make_transform([0, 0, 0], 0, 0, 0, trf_link2_joint2_2); 
make_child(trf_link2p2_link2_2, trf_viz_link2p2_2);
...
%% Joint 3: Links 2_2,3_2: Revoulute
j3_rot_axis_j3_2= [0,0,1]';
j3_rot_angle_2= 0; % [-pi/2, pi/2]

trf_joint3_link2_2= make_transform([0, 0.15, 0], pi/2, 0, 0, trf_link2_joint2_2);
trf_link3_joint3_2= make_transform_revolute(j3_rot_axis_j3_2, j3_rot_angle_2, trf_joint3_link2_2); 
plot_axes(trf_link3_joint3_2, 'L_3(2)', false, axis_length); 
make_child(trf_link3_joint3_2, trf_viz_link3_2);
%% Joint: Links 3,3-2: Fixed
trf_link3p2_link3= make_transform([0, 0, 0], 0, 0, 0, trf_link3_joint3); 
make_child(trf_link3p2_link3, trf_viz_link3p2);
%% Joint: Links 3,3-2_2: Fixed
trf_link3p2_link3_2= make_transform([0, 0, 0], 0, 0, 0, trf_link3_joint3_2); 
make_child(trf_link3p2_link3_2, trf_viz_link3p2_2);

%% Joint 4: Link 1 translation: 
...
make_child(trf_link4_joint4, trf_viz_link1);
...
for q1=[linspace(0, -pi/2, 30), linspace(-pi/2, pi/2, 30), linspace(pi/2, 0, 30)]
    set(handle_axes, 'XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
...
for q2_2=[linspace(0, -pi/2, 30), linspace(-pi/2, pi/2, 30), linspace(pi/2, 0, 30)]
    set(handle_axes, 'XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
    trf_q2_2= makehgtform('axisrotate', j2_rot_axis_j2_2, q2_2);
    set(trf_link2_joint2_2, 'Matrix', trf_q2_2);
    drawnow;
    pause(0.02);
end
...
for q3_2=[linspace(0, -pi/2, 30), linspace(-pi/2, pi/2, 30), linspace(pi/2, 0, 30)]
    set(handle_axes, 'XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
    trf_q3_2= makehgtform('axisrotate', j3_rot_axis_j3_2, q3_2);
    set(trf_link3_joint3_2, 'Matrix', trf_q3_2);
    drawnow;
    pause(0.02);
end
...
%         a4= (0.04)*(2*q(4) - 1);
        ...
        set(handle_axes, 'XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
        trf_q2_2= makehgtform('axisrotate', j2_rot_axis_j2_2, q4);
        set(trf_link2_joint2_2, 'Matrix', trf_q2_2);
        
        set(handle_axes, 'XLim', [-0.6,0.6], 'YLim', [-0.6,0.6], 'ZLim', [0,0.4]);
        trf_q3_2= makehgtform('axisrotate', j3_rot_axis_j3_2, q5);
        set(trf_link3_joint3_2, 'Matrix', trf_q3_2);
